...
public class JWTProvider {
    ...
    public void init() {
        try {
            ...
            throw new PostNotFoundExceptoion("Exception occured while loading keystore");
        }
    ...
    private PrivateKey getPrivateKey() {
        try {
            ...
            throw new PostNotFoundExceptoion("Exception occured while retrieving public key from keystore");
        }
    }
